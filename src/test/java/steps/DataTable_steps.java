...
public class DataTable_steps {
    ...
    @Given("User clicks to New Botton")
    public void user_clicks_to_New_Botton() {
    ...
    public void user_should_enter_position() {
        dtpObj.positionInput.sendKeys("retired assain");
    ...
    public void user_should_enter_extension(String ext) {
        dtpObj.extnInput.sendKeys(ext);

    }

    @Then("User should enter start date  {string}")
    public void user_should_enter_start_date(String data) {
        dtpObj.dateInput.sendKeys(data);
